...
| G | files, batches, audio, images, embeddings, vector stores | `internal/httpapi/`, `internal/providers/` | embeddings·OpenAI-compatible image generation·speech 생성·files/batches pass-through 이식, transcription/vector stores 대기 |
