...
| E | `litellm/proxy/**` | `internal/httpapi/`, `internal/auth/`, `internal/store/` | PostgreSQL·Redis cache·usage/spend·RPM·readiness·master-key 기반 virtual key 생성/조회/삭제/차단·해제 이식 |
