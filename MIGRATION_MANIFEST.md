...
| G | files, batches, audio, images, embeddings, vector stores | `internal/httpapi/`, `internal/providers/` | embeddings·OpenAI-compatible image generation·speech 생성 이식, files/batches/transcription/vector stores 대기 |
