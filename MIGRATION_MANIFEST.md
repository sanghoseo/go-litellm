...
| C | `litellm/main.py`, `utils.py`, `router.py`, router strategy | `pkg/litellm/`, `internal/routing/` | 공개 Completion/Embedding/SSE SDK·router 기본 이식 |
...
| E | `litellm/proxy/**` | `internal/httpapi/`, `internal/auth/`, `internal/store/` | PostgreSQL·Redis·usage/spend·virtual key RPM 이식 |
