...
| E | `litellm/proxy/**` | `internal/httpapi/`, `internal/auth/`, `internal/store/` | PostgreSQL·Redis cache·chat/text/response/embedding/moderation usage·spend·RPM·readiness·master-key 기반 virtual key·team·user·project 생성/조회/목록/부분수정/차단·해제/삭제 및 user/team/project/key 모델 allowlist 교차 검증 이식 |
