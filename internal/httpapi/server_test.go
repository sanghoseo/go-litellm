...
func TestFilesAndBatchesUseConfiguredDefaultDeployment(t *testing.T) {
	...
	for _, testCase := range []struct {
		...
		{http.MethodPost, "/v1/realtime/client_secrets", "realtime/client_secrets"},
		{http.MethodPost, "/v1/realtime/calls", "realtime/calls"},
		{http.MethodPost, "/v1/realtime/transcription_sessions", "realtime/transcription_sessions"},
		{http.MethodPost, "/v1/evals", "evals"},
		{http.MethodGet, "/v1/evals/eval-123", "evals/eval-123"},
		{http.MethodDelete, "/v1/evals/eval-123", "evals/eval-123"},
		{http.MethodPost, "/v1/evals/eval-123/cancel", "evals/eval-123/cancel"},
		{http.MethodGet, "/v1/evals/eval-123/runs", "evals/eval-123/runs"},
		{http.MethodPost, "/v1/evals/eval-123/runs", "evals/eval-123/runs"},
		{http.MethodGet, "/v1/evals/eval-123/runs/run-123", "evals/eval-123/runs/run-123"},
		{http.MethodDelete, "/v1/evals/eval-123/runs/run-123", "evals/eval-123/runs/run-123"},
		{http.MethodPost, "/v1/videos", "videos"},
		{http.MethodGet, "/v1/videos/video-123", "videos/video-123"},
		{http.MethodGet, "/v1/videos/video-123/content", "videos/video-123/content"},
		{http.MethodPost, "/v1/videos/video-123/remix", "videos/video-123/remix"},
		{http.MethodPost, "/v1/videos/characters", "videos/characters"},
		{http.MethodGet, "/v1/videos/characters/character-123", "videos/characters/character-123"},
		{http.MethodPost, "/v1/videos/edits", "videos/edits"},
		{http.MethodPost, "/v1/videos/extensions", "videos/extensions"},
